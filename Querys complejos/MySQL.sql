...
select * from Estado;
insert into Estado(estado) values ('Estado de Mexico');
...
insert into Municipio(municipio) values ( 'Ecatepec de Morelos');
insert into Municipio(municipio) values ( 'Boca del Rio');
...
---------------------3
create  table Calle1 (
ID_Calle int auto_increment primary key not null,
Estado varchar (50) not null,
Num_Int int not null,
Num_Ext int not null
);
select * from Calle1;
insert into Calle1(Estado,Num_Int,Num_Ext) values ('Benito',55,60);
...
ID_Colonia int auto_increment primary key not null,
Colonia varchar (50) not null,
C_P int not null
);
select * from Colonia1;
insert into Colonia1(Colonia,C_P) values ('San Lorenzo Tetlixtac',54985);
...
insert into Telefono(Telefono) values (55580792);
...
ID_TCliente int auto_increment primary key not null,
Tipo varchar (50) not null
);
select * from Tipo_Cliente;
insert into Tipo_Cliente(tipo) values ('Suprime');
...
ID_TServicio int auto_increment primary key not null,
Servicio varchar (50) not null
);
select * from Tipo_Servicio;
insert into Tipo_Servicio(servicio) values ('Privado');
insert into Tipo_Servicio values ('Publico');

create table Banco (
ID_Banco int auto_increment primary key not null,
Banco varchar (50) not null
);
select * from Banco;
insert into Banco(banco) values ('HSBC');
...
ID_Referencia int auto_increment primary key not null,
Cuenta int not null,
